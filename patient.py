...
states = {
	...
	'GA':16, 'CT':17, 'OK':18, 'OH':19, 'KS':20, 'SC':21,'KY':22,'OR':23,
	'SD':24,'DE':25,'HI':26,'TX':27,'LA':28,'TN':29, 'PA':30,'VA':31,'AK':32,
	'AL':33,'AR':34,'VT':35,'IL':36,'IN':37,'IA':38,'AZ':39,'ID':40,'ME':41,
	'MD':42,'MA':43,'UT':44,'MO':45,'MN':46,'MI':47,'MT':48,'MS':49,'PR':50,'DC':51
}
